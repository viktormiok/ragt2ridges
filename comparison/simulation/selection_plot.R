...
boxplot(as.matrix(h1$ridgeFa)[, 1],
        at=2, 
        xaxt="n",
        add=TRUE, 
        col="blue",
...
boxplot(as.matrix(h2$ridgeFa)[, 1],
        at=5,
        xaxt="n", 
        add=TRUE,
        col="blue",
...
boxplot(as.matrix(c1$ridgeFa)[, 1],
        at=8, 
        xaxt="n", 
        add=TRUE, 
        col="blue",
...
boxplot(as.matrix(c2$ridgeFa)[, 1],
        at=11, 
        xaxt="n",
        add=TRUE,
        col="blue",
...
boxplot(as.matrix(r1$ridgeFa)[, 1],
        at=14, 
        xaxt="n",
        add=TRUE,
        col="blue",
...
boxplot(as.matrix(r2$ridgeFa)[, 1],
        at=17, 
        xaxt="n",
        add=TRUE,
        col="blue",
